...
(def resource-list {:resources [{:name "Destiny"    :path "/destiny"    :last-updated "04/11/2019" :desc "Star Wars Destiny card game data"}
                                ...
                                {:name "Warhammer Champions"  :path "/wh_champions"  :last-updated "04/11/2019" :desc "Warhammer Age of Sigmar: Champions card game data"}]})
